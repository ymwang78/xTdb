...
typedef enum {
    XTDB_SUCCESS = 0,
    XTDB_ERROR_INVALID_PATH = 1,
    XTDB_ERROR_CONTAINER_OPEN_FAILED = 2,
    XTDB_ERROR_CONTAINER_HEADER_INVALID = 3,
    XTDB_ERROR_METADATA_OPEN_FAILED = 4,
    XTDB_ERROR_WAL_OPEN_FAILED = 5,
    XTDB_ERROR_CHUNK_ALLOCATION_FAILED = 6,
    XTDB_ERROR_STATE_RESTORATION_FAILED = 7,
    XTDB_ERROR_WAL_REPLAY_FAILED = 8,
    XTDB_ERROR_ENGINE_NOT_OPEN = 9,
    XTDB_ERROR_INVALID_DATA = 10,
    XTDB_ERROR_INVALID_HANDLE = 11,
    XTDB_ERROR_OUT_OF_MEMORY = 12,
    XTDB_ERROR_INVALID_PARAMETER = 13,
    XTDB_ERROR_QUERY_FAILED = 14,
    XTDB_ERROR_WRITE_FAILED = 15,
    XTDB_ERROR_FLUSH_FAILED = 16
} xtdb_error_t;
